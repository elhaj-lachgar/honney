export function verficationEmail(restCode, username) {
  return `<html dir="ltr" lang="ar">
  <head>
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <img
                              alt="AWS&#x27;s Logo"
                              src="https://res.cloudinary.com/dndl3sgtl/image/upload/f_auto,q_auto/mhuojthgeiyhrsoqpfb3"
                              style="
                                display: block;
                                outline: none;
                                border: none;
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            >
                            شكراً لبدء عملية إنشاء حساب جديد. نريد التأكد من أنك بالفعل صاحب الطلب. يرجى إدخال رمز التحقق التالي عند الطلب
                            </p>
                            <table
                              align="center"
                              width="100%"
                      ...
                      <tbody>
                        <tr>
                          <td>
                            ...
                            >
                            لن تقوم ساجا أبداً بإرسال بريد إلكتروني لك تطلب منك الكشف عن أو التحقق من كلمة المرور الخاصة بك، أو رقم بطاقة الائتمان، أو رقم الحساب المصرفي
                            </p>
                          </td>
                        </tr>
                      </tbody>
...
export function OrderMailContent(order, userName) {
  return ` <html>
  <head>
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
                        ...
                        <tr>
                          <td>
                            ...
                            <p
                              style="font-size:14px;line-height:24px;margin:24px 0;color:#333;font-family:-apple-system, BlinkMacSystemFont, &#x27;Segoe UI&#x27;, &#x27;Roboto&#x27;, &#x27;Oxygen&#x27;, &#x27;Ubuntu&#x27;, &#x27;Cantarell&#x27;, &#x27;Fira Sans&#x27;, &#x27;Droid Sans&#x27;, &#x27;Helvetica Neue&#x27;, sans-serif;margin-bottom:14px"
                            >
                            شكرًا لطلبك من ساجا. سنتصل بك لتأكيد معلومات الطلب خلال ساعة إلى 24 ساعة، يرجى إبقاء هاتفك مفتوحًا. بمجرد شحن طردك، سنرسل لك بريدًا إلكترونيًا يحتوي على رابط لتتبع طلبك. إذا كانت لديك أي أسئلة بخصوص طلبك، يمكنك إرسال بريد إلكتروني إلينا على
                            </p>
                            <table
                              align="center"
                              width="100%"
                              ...
                              <tbody>
                                <tr>
                                    ...
                                    <div></div>
                                      ...
                                      <p>
                                        الهاتف:
${" "} ${"+212" + order?.address?.phone}
                                      </p>
                                      <p> 
                                        <span>
                                          ${order?.totalePrice} MAD
                                        </span>
                                        المجموع :
                                      </p>
                                    </div>
                                    ...
                                    <table style="border-collapse: collapse;padding: 25px">
                                      <tr style="border:1px solid #dddddd ; text-align:left ; padding: 8px;">
                                        <th  style="border:1px solid #dddddd ; text-align:left ; padding: 8px;">المنتج</th>
                                        <th style="border:1px solid #dddddd ; text-align:left ; padding: 8px;">الكمية</th>
                                        <th style="border:1px solid #dddddd ; text-align:left ; padding: 8px;">الثمن</th>
                                      </tr>
...
export function OrderAdminContent(order, userName) {
  return `<html>
  <head>
    <meta content="text/html; charset=UTF-8" http-equiv="Content-Type" />
    <meta name="x-apple-disable-message-reformatting" />
